...
type: "personal"
description: "RightClickVirusTotal is a Python-based tool that adds file virus scanning directly to your context menu via the VirusTotal API. Now available with CLI and GUI for Windows, Linux, and macOS."
keywords: "RightClickVirusTotal, VirusTotal API, Python virus scanner, file analysis, security tool, Tkinter GUI, CLI scanner, cross-platform malware detection, right-click integration, PyInstaller, Windows context menu tool"
...
![universal_cli_demo](https://cdn.statically.io/gh/smp46/smp46.github.io/nextjs/assets/rcvt/Universal_CLI.png)
...
![image](https://cdn.statically.io/gh/smp46/smp46.github.io/nextjs/assets/rcvt/Windows_Instructions.png)
