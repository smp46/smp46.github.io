...
type: undergrad
description: >-
  MazeGame is a Java-based puzzle game featuring a goose navigating dynamic
  mazes with autosolve functionality using BFS. Includes CLI and GUI modes with
  asset integrity checks.
keywords: >-
  MazeGame, Java game, JavaFX, maze solver, BFS algorithm, Java CLI, game
  development, Java multithreading, Java GUI, puzzle game, intro to Java
...
![Demo](https://cdn.statically.io/gh/smp46/smp46.github.io/nextjs/public/assets/mazegame/GUI_Assets.gif)
...
![cli medium maze](https://cdn.statically.io/gh/smp46/smp46.github.io/nextjs/public/assets/mazegame/CLI.png?q=85)

### GUI No-Assets Mode

![gui medium maze no-asset](https://cdn.statically.io/gh/smp46/smp46.github.io/nextjs/public/assets/mazegame/GUI_No_Assets.png?q=85)

### GUI Assets Mode

![gui medium maze](https://cdn.statically.io/gh/smp46/smp46.github.io/nextjs/public/assets/mazegame/GUI_Assets.png?q=85)
