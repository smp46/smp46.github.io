        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="bg-white shadow-lg rounded-lg p-6">
            ...
            <ul className="mt-4 text-xl list-disc pl-5 space-y-3">
              ...
              <li>
                Reaching out to industry to secure talks, sponsorships and other experiences for our
                members.
              </li>
              <li>Overall, running and supporting a rapidly growing university club.</li>
            </ul>
          </div>
          <div className="bg-white shadow-lg rounded-lg p-6">
            <h3 className="text-3xl font-semibold">
            ...
            <ul className="mt-4 text-xl list-disc pl-5 space-y-3">
              <li>
                Working in the primary retail store for the company, focusing on sales of
                refurbished laptops and desktops.
              </li>
              <li>Both in person and over the phone sales and tech support.</li>
              <li>
                Continued to utilise technical skills to assist with and enhance on-site tech work
                and refurbishment.
              </li>
            </ul>
          </div>
          <div className="bg-white shadow-lg rounded-lg p-6">
            ...
            <ul className="mt-4 text-xl list-disc pl-5 space-y-3">
              <li>
                Customer facing computer technician role with a focus on computer repairs, customer
                support and retail sales.
              </li>
              <li>
                Promoted from work experience to a traineeship to a full-time position within the
                business.
              </li>
              <li>Helped manage the commencement of a new shopfront and solo operated stores.</li>
            </ul>
          </div>
        </div>
        <div className="mt-8 text-center text-xl">
          <p>
            Send me an email or contact me on LinkedIn for more information or to request a full
            résumé.
          </p>
          <div className="flex justify-center space-x-4 mt-4">
            <a href="mailto:me@smp46.me" target="_blank" rel="noopener noreferrer">
              <SiGmail size="40" />
            </a>
            <a href="https://linkedin.com/in/smp46" target="_blank" rel="noopener noreferrer">
              <FaLinkedin size="40" />
            </a>
          </div>
        </div>
