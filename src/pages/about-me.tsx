    ...
    <div id="about-me" className="lg:grid-cols-2 gap-8 items-center py-12 px-6">
      ...
      <div className="text-center mt-9">
        ...
        <p className="text-lg mb-4">
          ...
          member of the UQ Cyber Squad, where we are lucky enough to get
          regular industry talks and workshops. I enjoy participating in CTFs
          and follow the industry closely.
        </p>
        <p className="text-lg">
